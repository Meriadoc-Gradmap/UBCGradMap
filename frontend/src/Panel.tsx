...
export default function Panel(props: {currentCourse: Course | undefined}) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 lg:top-20 lg:left-0 lg:right-auto h-1/4 lg:h-auto lg:w-1/4 m-5 bg-white shadow-md rounded p-3 overflow-y-auto overflow-x-wrap">
      <h1 className="text-xl">{props.currentCourse.code} - {props.currentCourse.name}</h1>
